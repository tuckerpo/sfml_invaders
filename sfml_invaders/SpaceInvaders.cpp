...
SpaceInvaders::SpaceInvaders() : Game(), m_window(sf::VideoMode(1500, 1000), "Space Invaders") {
    // Window init
...
void SpaceInvaders::doCollisions() { return; }

const std::string& SpaceInvaders::getName() const { return m_name; }